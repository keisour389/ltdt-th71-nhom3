    ...
    public void getOrderById(int orderId)
    {
        ...
        call.enqueue(new Callback<OrdersData>() {
            ...
            public void onResponse(Call<OrdersData> call, Response<OrdersData> response) {
                ...
                totalPrice += orderSearchByID[0].getShippingCost(); //Cộng thêm phí ship vào phần tổng
                totalPriceInCusOrder.setText("Tổng cộng: " + String.valueOf(totalPrice)); //Set total
