...
public class DanhSachDoAnAdapter extends ArrayAdapter<String> {
    private final Activity context;
    private final String[] maintitle;
    private final String[] subtitle;
    private final Integer[] imgid;

    public DanhSachDoAnAdapter(Activity context, String[] maintitle, String[] subtitle, Integer[] imgid)
    {
